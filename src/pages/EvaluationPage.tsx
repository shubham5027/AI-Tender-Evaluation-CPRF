    ...
    <div>
      ...
      <div className="p-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-6">
          <p className="text-[11px] font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3">Evaluation Progress</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Evaluation Results</h2>
              <span className="text-xs text-gray-400 dark:text-gray-500">({filtered.length} records)</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <select
                  ...
                  className="text-xs border border-gray-200 dark:border-gray-700 rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-2 focus:ring-navy-500 bg-white dark:bg-gray-800"
                >
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-700/50">
                  ...
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Bidder</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Criterion</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Extracted Value</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Decision</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Confidence</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Source</th>
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider">Explain</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {filtered.map((evalItem) => (
                  <>
                    <tr key={evalItem.id} className="hover:bg-gray-50 dark:bg-gray-700/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-100 max-w-[180px] truncate">{evalItem.bidderName}</td>
                      <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{evalItem.criterionName}</td>
                    ...
                    {expandedRows.has(evalItem.id) && (
                      <tr key={`${evalItem.id}-detail`} className="bg-gray-50 dark:bg-gray-700/50">
                        <td colSpan={8} className="px-8 py-4">
                          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                            <p className="text-[11px] font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2">AI Reasoning</p>
                            <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{evalItem.explanation}</p>
                          </div>
                        </td>
                      </tr>
                    )}
