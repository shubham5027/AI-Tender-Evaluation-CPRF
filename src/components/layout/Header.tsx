      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg w-64 focus:outline-none focus:ring-2 focus:ring-navy-500 focus:border-transparent bg-gray-50 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
          />
        </div>
        ...
        <div className="relative" ref={notifRef}>
          ...
          {isNotifOpen && (
            <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-50">
              ...
              <div className="max-h-72 overflow-y-auto">
                {notifications.map((item) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 ${
                      item.read ? 'bg-white dark:bg-gray-800' : 'bg-navy-50/40 dark:bg-navy-900/20'
                    }`}
                  >
                    <p className="text-sm text-gray-800 dark:text-gray-200">{item.text}</p>
                    <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-0.5">{item.at}</p>
                  </button>
                ))}
              </div>
            </div>
        ...
        <div className="relative" ref={userRef}>
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-tight">{demoUser ? demoUser.role : 'Not signed in'}</p>
            </div>
          </button>

          {isUserMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-50 p-2">
              {demoUser ? (
                <button
                  onClick={signOutDemo}
